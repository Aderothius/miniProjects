...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        ...
        if (nearest != null) {
            if (s.equals(nearest)) {
                nearestStopLabel.setText(s.getNumber() + ": " + s.getName());
            }
        } else {
            nearestStopLabel.setText(R.string.out_of_range);
        }
    ...
    public void onStopSelected(Stop stop) {
        try {
            ...
            // Copied directly from the implementation of DownloadArrivalsLocationDataTask. Changed name.
            // Section below is necessary to downloads, parses, and calls plotBus, sending bus info automatically to
            // plotBus
            ...
            e.printStackTrace();
            System.out.println("No stop available!");
        }
    }
