...
public class BusLocationPlotter extends MapViewOverlay {
    ...
    public void plotBuses() {
        ...
        // bus data coming in alr as plotBus is called
        // No need to call ItemizedIconOverlay<OverlayItem> createBusLocnOverlay(), alr called above.
        // Need to call in busLocationsOverlay
        ...
        if (selected != null) {
            ...
            for (Bus b : busList) {
                GeoPoint busGeo = Geometry.gpFromLatLon(b.getLatLon());

                OverlayItem item = new OverlayItem("","", busGeo);
